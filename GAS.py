"""
Semantic Alignment Score 1.1 (GAS 1.1) Animation

This Manim animation visualizes the Semantic Alignment Score (GAS) algorithm for text analysis,
...
6. Final GAS score computation with animated result highlighting
...
Usage:
    python -m manim -pql --disable_caching GAS.py FullConceptAnimation
"""
...
class FullConceptAnimation(Scene):
    """
    Main animation class for visualizing the Semantic Alignment Score (GAS) algorithm.
    ...
    def construct(self):
        """Main animation sequence orchestrating all GAS visualization components."""
        # ================== TITLE AND HEADING SETUP ==================
        # Create and animate the main title for Semantic Alignment Score
        title = Text("Global Alignment Score (GAS)", font_size=25).move_to(ORIGIN)
        ...
        sas_text = Text("GAS = ", font_size=15, color=WHITE)
